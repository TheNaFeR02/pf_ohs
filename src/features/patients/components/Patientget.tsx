      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
          <Card x-chunk="dashboard-01-chunk-0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {form.getValues("name")?.[0]?.given?.join(" ") +
                  " " +
                  form.getValues("name")?.[0]?.family}
              </div>
            </CardContent>
          </Card>
          <Card x-chunk="dashboard-01-chunk-1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {control._defaultValues.managingOrganization?.display}
              </div>
            </CardContent>
          </Card>
          <Card x-chunk="dashboard-01-chunk-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {control._defaultValues.gender +
                  " | " +
                  (control._defaultValues.birthDate !== undefined
                    ? new Date(
                        control._defaultValues.birthDate
                      ).toLocaleDateString()
          ...
          <Card className="xl:col-span-2" x-chunk="dashboard-01-chunk-4">
            <CardHeader className="flex flex-row items-center">
              <div className="grid gap-2">
                ...
                <CardDescription>secondary contacts.</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card x-chunk="dashboard-01-chunk-5">
            ...
            <CardContent className="grid gap-6">
              <Avatar className="hidden h-9 w-9 sm:flex">
                ...
                <AvatarImage
                  src={`data:image/png;base64,${control._defaultValues.photo?.[0]?.data}`}
                  alt="Avatar"
                />
              ...
              <div className="flex items-center gap-4">
                <div className="grid gap-1">
                  <p className="text-sm font-medium leading-none">
                    {control._defaultValues.maritalStatus?.coding?.[0]
                      ?.display !== undefined
                      ? control._defaultValues.maritalStatus?.coding?.[0]
                          ?.display
                      : "No definido"}
